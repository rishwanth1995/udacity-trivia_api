...
def create_app(test_config=None):
  ...
  '''
    ...
    def create_question():
        ...
        if not ('question' in question_json and 'answer' in question_json and
                'difficulty' in question_json and 'category' in question_json):
            abort(422)
        try:
            question = Question(question=question_json['question'],
